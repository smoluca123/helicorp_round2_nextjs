    ...
    <section id="design" className="w-full bg-black flex flex-col">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 md:px-8 xl:px-12 flex justify-end">
          ...
          <div className="w-full md:w-[50%] lg:w-[45%] flex flex-col items-start text-white">
            ...
            <p className="text-sm md:text-base text-zinc-300 leading-relaxed mb-10 text-justify md:text-left">
              Zephyrus G14 mới thu hút mọi ánh nhìn ngay từ lần tiếp xúc đầu
              tiên. Máy được gia công CNC chính xác từ hợp kim nhôm. Vật liệu có
              độ bền cao này có thể đúc thành các hình dạng phức tạp mà trông
              vẫn tuyệt đẹp sau khi được anode hóa thành màu Eclipse Gray hoặc
              tổ hợp màu Platinum White ấn tượng. Bản lề Easylift độc quyền của
              ROG cho phép mở máy dễ dàng và đóng nắp chỉ với một tay. Khung máy
              thanh mảnh và lớp hoàn thiện nhám mờ của Zephyrus G14 khiến ai
              cũng muốn chạm vào.
            </p>
      ...
      <div className="w-full bg-black text-white pt-24 pb-12 flex flex-col items-center justify-center px-4 md:px-8">
        ...
        <p className="text-sm md:text-base text-zinc-300 leading-relaxed max-w-4xl text-center md:text-justify mx-auto">
          Zephyrus G14 đã sẵn sàng làm sáng bừng cả thế giới với mảng đèn Slash
          Lighting. Mang thiết kế một dải đèn LED nổi bật chạy chéo theo nắp máy
          với lớp hoàn thiện tráng gương, được nâng cấp từ 7 lên 35 vùng riêng
          biệt trên bản 2026, Slash Lighting là sự tái hiện trực quan, thể hiện
          tính thanh lịch và bản sắc cá nhân, khiến Zephyrus trở nên độc nhất.
          Hệ thống đèn này được tích hợp sẵn 15 hình hoạt họa, gồm chế độ Trạng
          thái pin và chế độ Sạc, cho phép bạn quan sát được mức pin của máy dù
          đứng ở xa. Tất cả các hình hoạt họa đều có thể tùy chỉnh hoàn toàn
          trong Armoury Crate, để bạn có thể biến G14 thành của riêng mình.
        </p>
      </div>
